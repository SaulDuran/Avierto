    ...
    'common': {
      init: function() {
        ...
        $(window).load(function() {
          $(".grid-loader-container").delay(600).animate({
            top: h_Window
      ...
      init: function() {
        ...
        function updateLoadingStatus() {
          ...
          if(percentLoaded === 100){
            ...
            videoElement.play();
            videoElement.removeEventListener("progress", updateLoadingStatus);
          } else {
      ...
      init: function() {
        ...
        if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
          ...
          $('.panelActividad').hover(function(){
            ...
            //$('.panelActividad').removeClass("act-dis-color");
            //$(mainContainer).css("background", "#fff");
            //$('#accordion-actividades').find( '#' + bck ).removeClass( "img_act_in_back" );
            //$(this).removeClass("act-select-color");
            //$('.panelActividad .panel-body').css("color", "#4bae90");
            //$('.texto-align-actividades').css("color", "#4bae90");
          });
        }
      }
    },
