...
<footer>
	<div class="row <?= $color_bar_1; ?> footer">
		...
		<div class="col-xs-12 copyright <?= $color_bar_2; ?>">&copy;2015 Avierto, Derechos Reservados | <a href="http://avierto.com.mx/terminos-y-condiciones/">Términos y condiciones</a> | <a href="http://avierto.com.mx/politica-de-privacidad/">Política de privacidad</a> </div>
	</div> <!-- /Footer -->
</footer>
