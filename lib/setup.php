...
function assets() {
  ...
  wp_enqueue_script('sage/classie', Assets\asset_path('scripts/classie.js'), ['jquery'], null, false);
  wp_enqueue_script('sage/lazy', Assets\asset_path('scripts/lazy-line-painter.js'), ['jquery'], null, false);
